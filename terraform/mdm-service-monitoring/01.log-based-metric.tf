...
# https://cloud.google.com/monitoring/access-control#workspace_roles_desc


#Can you try this for the log message ? I made an assumption that the value after the 200 is the duration ? Let me know if that's not the case.  
# resource "google_logging_metric" "logging_metric" {
